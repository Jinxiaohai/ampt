...
c$$$             WW        WW      RR  RR   II     TT     EEEEEE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            write(9984,*)"projectile nsubp = ", nsubp
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
c$$$           WW   WW   WW   WW   RRRRR    II     TT     EEEEEE
...
c$$$             WW        WW      RR  RR   II     TT     EEEEEE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            write(9984,*)"projectile (nisg + nsg) = ",nisg
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
c$$$           WW   WW   WW   WW   RRRRR    II     TT     EEEEEE
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      IF (IOUT .EQ. 1) THEN
cbzdbg2/16/99
      write(6789,*) ' in HJANA1 '
      write(6789,*) ' total number of partons = ', nsubp
      write(6789,*) ' total number of gluons = ', nsubg, MUL
      write(6789,*) ' number of projectile strings = ', IHNT2(1)
      write(6789,*) ' number of target strings = ', IHNT2(3)
      write(6789,*) ' number of independent strings = ', NSG
      write(6789,*) ' in HJANA1 '
      write(6789,*) ' total number of partons = ', nsubp / IW
      write(6789,*) ' total number of gluons = ', nsubg / IW
      write(6789,*) ' number of projectile strings = ', IHNT2(1)
      write(6789,*) ' number of target strings = ', IHNT2(3)
      write(6789,*) ' number of independent strings = ', NISG / IW
cbzdbg2/16/99end
      END IF
c
      RETURN
