...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        BMIN=MIN(BMIN0,BMAX)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        如果弹核和靶核的核子数小于等于1,给出碰撞参数的下限和上限.
c$$$        此条件语句共四行。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        Hulthen wave function 对于氘核.(氘核核子的初始化).
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        如果入射的弹核是氘核,给出氘核的质子和中子的坐标信息.
c$$$        此条件语句共计20行.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
C********************
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$          对MISS进行初始化MISS = 0, MISS 究竟是什么数值???
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        此调用在它们自己的核子中完成核子的弹性散射和可能的cascade.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
              CALL HIJCSC(JP,JT)
              GO TO 70
...
clin-5/22/01 write impact parameter:
        bimp=bb
        write(6,*) "impact parameter                       ", bimp
        write(6,*) "loop number to initial a event         ", nlop
        write(6,*) "total number interactions proj and targ", ncolt
c$$$        write(6,*) '#impact parameter,nlop,ncolt=',bimp,nlop,ncolt

c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        下面的条件语句:如果碰撞的次数为0,即未发生碰撞,并且循环的次数
c$$$        也小于20.则程序跳到第20行,则重新初始化此次事件.
c$$$        此条件语句总共6行。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        IF(NCOLT.EQ.0) THEN
           NLOP=NLOP+1
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        IHPR2(3):(D=0)switch for triggered hard scattering with
c$$$        specified Pt >= HIPR1(10).
c$$$        = 0 : no triggered jet production.
c$$$        = 1 : ordinary hard processes
c$$$        = 2 : only direct photon production
c$$$        下面的条件语句说明,如果IHPR2(3)不等于0,则为硬过程。
c$$$        此条件语句共计8行。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        IHPR2(9):(D=0)switch to guarantee at least one pair of
c$$$        minijets production per event (pp, pA or AB).如果为1,则
c$$$        用户强制产生。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        NFP(I,11): total number of interactions projectile nucleon
c$$$        (hadron) I has suffered so far.(第I个核子相互作用的次数)。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                NFP(JP,11)=NFP(JP,11)+1
                NFT(JT,11)=NFT(JT,11)+1
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        N01,N10,N11等是核子的受伤状态。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$        NFP(I,10): to indicate whether the valence quarks of
c$$$        diquarks (anti_quarks) in projectile nucleon (hadron) I suffered
c$$$        a hard scattering.(核子I的价夸克是否参与了硬散射)。
c$$$        初始的情况是没有参加硬散射。
c$$$        = 0 : has not suffered a hard scattering.
c$$$        = 1 : suffered one or more hard scatterings in current binary
c$$$        nucleon-nucleon collision.
...
C*****************************************************************
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      IHPR2(8)=0无jet产生,IHPR2(3)=0 switch for triggered hard
c$$$      specified .
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        IF(IHPR2(8).EQ.0 .AND. IHPR2(3).EQ.0) GO TO 160
C                ********When IHPR2(8)=0 no jets are produced
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        jets can not be produced for (JP,JT),因为对于JP或JT没有足够
c$$$        的能量.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
C                ******** jet with PT>HIPR1(11) will be quenched
 ...
 160        CONTINUE
        ...
        IF(IERROR.NE.0) THEN
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        IHPR2(10):缺省值是0,当不是零的时候既有错误发生。
c$$$        然后舍弃此次初始，重新初始此次事件。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
clin-4/2012 
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        下面的测试程序输出初始核子在相空间的所有信息。
c$$$        下面的非测试程序根据核子的状态值输出弹核的每个核子参与
c$$$        反应的状态信息。(即201循环所干的所有事情)。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        下面的测试程序输出初始核子在相空间的所有信息。
c$$$        下面的非测试程序根据核子的状态值输出靶核的每个核子参与
c$$$        反应的状态信息。(即202循环所干的所有事情)。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        DO 202 JT=1,IHNT2(3)
...
c$$$        interact with excited nuclear matter. When the Pt
c$$$        of a jet is smaller than HIPR1(11) it will stop interacting
c$$$        further.(当PT的数值小于HIPR1(11)时,JET就不和激发的物质产生
c$$$        相互作用)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        下面的if条件语句和DO循环语句完成JET的猝灭,即JET和核物质的相
c$$$        互作用。(所有的粒子产生都已经完成)。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        下面的程序以缺省的方式(isoft=1)处理strings.共计194行。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        if(isoft.eq.1) then
...
cbz2/4/99end
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        上面的程序以缺省的方式(isoft=1)处理strings.共计194行。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        以string melting的方式处理fragment strings.并将强子转化成
c$$$        部分子。(isoft = 4).
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
clin-4/24/01 normal fragmentation first:
        ...
        IF(IHPR2(20).NE.0) THEN
           DO 560 ISG=1,NSG
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      HIJFRG():TO arrange the produced partons together with the valence
c$$$      quarks and diquarks(anti-quarks)and LUEXEC subroutine in JETSET
c$$$      is called to perform the frigmentation for each string system.
c$$$      (安排产生的部分子和夸克以及反夸克,配合LUEXEC程序两个程序共同完
c$$$      成)。
c$$$      NTP = 1：fragment projectile string.
c$$$      NTP = 2: fragment target string.
c$$$      NTP = 3: independent strings from jets.
c$$$      JTP is the line number of the string fragment all leading strings
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        NATT:产生的稳定粒子的总数。
c$$$        KATT(NATT,1):产生的粒子的味道代码,即粒子的ID。
c$$$        KATT(NATT,2):status codes to identify the sources
c$$$                    from which the particles come.
c$$$        KATT(NATT,4):粒子的状态代码。
c$$$        KATT(I,3):line number of the parent particle.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   K(I,4)=nsbstR
                   NATT=NATT+1
                   KATT(NATT,1)=K(I,2)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        PATT(NATT,1..4):产生的粒子的四动量(px,py,pz,E)。
c$$$        EATT：这应该是在统计系统的总能量的吧。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   PATT(NATT,1)=P(I,1)
                   PATT(NATT,2)=P(I,2)
                   PATT(NATT,3)=P(I,3)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$                   下面的这十几行是关于产生的粒子的详细信息。
c$$$                   EATT:为总的能量.
c$$$                   GXAR(NATT):为坐标X.
c$$$                   GYAR(NATT):为坐标Y.
c$$$                   GZAR(NATT):为坐标Z.
c$$$                   FTAR(NATT):为时间.
c$$$                   ITYPAR(NATT):为粒子的ID号.
c$$$                   PXAR(NATT):为粒子的px.
c$$$                   PYAR(NATT):为粒子的py.
c$$$                   PZAR(NATT):为粒子的pz.
c$$$                   PEAR(NATT):为粒子的能量.
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        下面的程序是q-qbar JETS 系统的碎片.
c$$$        IHNT2(1),IHNT2(3):为系统的质量数,即核子数.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
           JTP(1)=IHNT2(1)
           JTP(2)=IHNT2(3)
           DO 600 NTP=1,2
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        NFTP=NFP(jjtp,5)为系统的弹核的每个核子的碰撞状态.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                NFTP=NFP(jjtp,5)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$           NDR:直接产生的粒子的总数.
c$$$           KATT(NATT,1):直接产生的粒子的ID号.
c$$$           KATT(NATT,2):status codes to identify the sources from which
c$$$           the particles come.
c$$$           KATT(NATT,3):line number of the parent particle.
c$$$           PATT(NATT,1),PDR(I,1):粒子的PX.
c$$$           PATT(NATT,2),PDR(I,2):粒子的PY.
c$$$           PATT(NATT,3),PDR(I,3):粒子的PZ.
c$$$           PATT(NATT,4),PDR(I,4):粒子的ENERGY.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        DO 650 I=1,NDR
                NATT=NATT+1
                KATT(NATT,1)=KFDR(I)
...
clin-6/2009
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         子程序embedHighPt的作用: embed back-to-back high-Pt
c$$$         quark/antiquark pair via
c$$$         embedding back-to-back high-Pt pion pair then melting the pion
c$$$         pair by generating the internal quark and antiquark momentum
c$$$         parallel to the pion momentum (in order to produce a high-Pt
c$$$         and a low Pt parton)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
         call embedHighPt
...
c
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        子程序HJANA1的作用:analysis subroutine in HIJING before
c$$$        parton cascade evolution(分析前端产生的所有结果,未进入ZPC之
c$$$        前)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
         CALL HJANA1
...
clin-7/03/01 move up, used in zpstrg (otherwise not set and incorrect):
        ...
        nst=0
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            write(*,*) "after call htop, natt = ", natt
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        nsg=natt
        NSI=NSG
clin-7/03/01-end
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<
             write(9989,*)"iityp,nstrg,npart,k2,px,py,pz,pm,PE,x,y,z,t"
             write(9989,*)iityp, nstrg, npart, k2sgs(nstrg,npart), 
     &                   pxsgs(nstrg,npart), pysgs(nstrg,npart),
     &                   pzsgs(nstrg,npart), pmsgs(nstrg,npart),
     &                   pesgs(nstrg,npart), gxsgs(nstrg,npart),
     &                   gysgs(nstrg,npart), gzsgs(nstrg,npart),
     &                   ftsgs(nstrg,npart)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
...
c$$$             WW        WW      RR  RR   II     TT     EEEEEE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$             convert partons to hadrons after ZPC.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
c$$$           WW   WW   WW   WW   RRRRR    II     TT     EEEEEE
...
c$$$             WW =       WW      RR  RR   II     TT     EEEEEE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<
              write(9988,*)"NATT,katt,px,py,pz,e,x,y,z,t,itypar"
              write(9988,*)NATT, KATT(NATT,1), PATT(NATT,1),
     &             PATT(NATT,2),PATT(NATT,3), PATT(NATT,4),
     &             GXAR(NATT),GYAR(NATT),GZAR(NATT),
     &             FTAR(NATT),ITYPAR(NATT)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
c$$$           WW   WW   WW   WW   RRRRR    II     TT     EEEEEE
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        猜测PROJ为projectile的缩写，下面这些代码为初始弹核的味道.
c$$$        IHNT2(5)为弹核强子的味道代码(粒子ID).
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        IF(PROJ.NE.'A') THEN
                IF(PROJ.EQ.'P') THEN
                    IHNT2(5)=2212
                ...
                ENDIF
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        HINT1(8)为弹核粒子的静止质量,由粒子代码来初始化质量.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                HINT1(8)=ULMASS(IHNT2(5))
        ENDIF
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        同理下面是初始化弹核的每个核子的,参考上面初始化弹核的方法.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        IF(TARG.NE.'A') THEN
                IF(TARG.EQ.'P') THEN
                    IHNT2(6)=2212
        ...
        ENDIF
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        关掉pi0, k0s, lambda, sigma+-, xi0-, omega等粒子的衰变开关。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
C...Switch off decay of pi0, K0S, Lambda, Sigma+-, Xi0-, Omega-.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        如果衰变的开关值>0,则进行下面的下下面粒子开关的关闭。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        不发生K* decays。ID(313, -313, 323, -323)是K*粒子。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
cbz12/4/98
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        不发生rho粒子的衰变。ID(213,113,223,333)是rho粒子。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
cbz12/4/98end
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        不发生pi0(111), Ks0(310), D+(411), D0(421), Ds+(431),
c$$$        B0(511), B+(521), Bs0(531), Sigma-(3112), Lambda(3122)
c$$$        Sigma0(3212), Sigma+(3222), Xi-(3312), Xi0(3322), Omega-(3334)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        no HQ(charm or bottom) decays in order to get net-HQ
c$$$        conservaton.(其中HQ是什么？？？？？？)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
clin-7/2011-no HQ(charm or bottom) decays in order to get net-HQ conservation:
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        不发生Etac(1S)(441)衰变等其他粒子的衰变。！！！！！！！
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        MSTU(21)=1
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        如果没有错误发生，初始化MSTU数组的MSTU(22), MSTU(25), MSTU(26)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        HIPR1(2):(D=0.35GeV)width of the Gaussian Pt disstribution
c$$$        of produced hadron in Lund string fragmentation.产生的强子
c$$$        的横动量的分布.
c$$$      =+============================================================
        PARJ(21)=HIPR1(2)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        设定产生的强子的横动量的最小值为PT = 0.4GeV
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        PARJ(2)=min(PARJ(2),0.4)

C                        ******** set up for jetset
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        DD1为读进去的能量,DD2为弹核静止质量,DD3为靶核的静止质量.
c$$$        HINT1(1)为质心系的能量.HINT1(2)洛伦兹变换变量Beta. HINT1(3):
c$$$        质心系的快度. HINT1(4):弹核快度. HINT1(5):靶核的快度。
c$$$        当FRAME 为 LAB时, 明显的靶核是静止的。
c$$$        当FRAME 为 CMS时, 明显的是相碰。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        IF(FRAME.EQ.'LAB') THEN
           DD1=dble(EFRM)
           DD2=dble(HINT1(8))
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        子程序HIJCRS的作用：to calculate cross sections of minijet
c$$$        production, cross section of the triggered processes, elastic,
c$$$        inelastic and total cross section of nucleon-necleon (or hard)
c$$$        collisions within the eikonal formalism.(计算散射截面)。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        CALL HIJCRS
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        IHPR2(5):switch for the Pt kick due to soft interactions.
c$$$        HIFUN函数: One calls first HIFUN,with assigned channel number I,
c$$$        low and up limits.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        parameters in the distribution for the PT kick from soft
c$$$        interactions.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        FUNCTION FNKICK(X)
        COMMON/HPARNT/HIPR1(100),IHPR2(50),HINT1(100),IHNT2(50)
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        对于disassociated excitation在单个的衍射碰撞中,价夸克的分布。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        FUNCTION FNSTRS(X)
        COMMON/HPARNT/HIPR1(100),IHPR2(50),HINT1(100),IHNT2(50)
cc      SAVE /HPARNT/
...
cc      SAVE /HPARNT/
        SAVE   
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        P(I,3)为实验室系的能量，P(I,4)为质心系能量的一半。
c$$$        Y为快度。AMT为Mn.所有的具体的内容参看马老师书的245页。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        DO 100 I=1,N
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        SUBROUTINE QUENCH(JPJT, NTP)程序的作用: to perform jet
c$$$        quenching by allowing final state interaction of produced jet
c$$$        inside the excited strings. The energy lost by the jets will
c$$$        be transferred to other string systems.   quench(终止)。
c$$$        JPJT:弹核的每个核子或者靶核的每个核子或者是string systems.
c$$$        NTP：当其值为1时,是弹核在调用，当其值为2时，是靶核在调用，
c$$$             当其值为3时，是strings systems在调用。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
C
...
c     Uzhi:
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        HINT1(19):最近一次的碰撞参数,
c$$$        HINT1(20):碰撞参数再横平面内的方位角的详细信息。
c$$$        BBX：X 方向的分量.
c$$$        BBY：Y 方向的分量.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        BB=HINT1(19)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        JP=JPJT
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        NPJ(I):(I,...,IAP)numbers of partons associated with
c$$$        projectile nucleon I.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        如果JET的横动量小于HIPR1(11)=2.0GeV,或者交换的横动量小于HIPR1(8)
c$$$        = 2.0GeV.然后给出JET在方向PHIP方向的相互作用。
c$$$        NPJ(JP):number of partons associated with projectile nucleon I.
c$$$        PTJET0为横动量，PJPX(JP,I)为第JP个弹核的核子产生的第I个部分子的
c$$$        X方向的动量,同理其他的。PTOT为总的动量。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        DO 290 I=1,NPJ(JP)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        找到受伤的弹核的核子，这些核子可以和JET相互作用.(这些受伤的
C$$$        核子既可以是弹核也可以靶核,这是从下面的程序进行的猜测).
c$$$        NFP(I,5)为弹核第I个核子的碰撞状态，其中3是变成了激发弦。
c$$$        其中I2也不能等于JP，因为这是同一个核子,(不可能破碎后还和自己
c$$$        没破碎的相互作用)。DX，DY为分量距离,DR0为横平面内的距离。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
           KP=0
           DO 100 I2=1,IHNT2(1)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                 ...
                 V3=PJPZ(JP,I)/PTOT
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        DRR:应该是a gluon jet在激发的核物质之间传播的距离.
c$$$        HIPR1(14):为a gluon jet在核物质之间传播的单位距离的
c$$$        能损。DP应该为总的能量损失。
c$$$        KFPJ(JP,I):猜测为第JP个核子产生的第I个JET的ID号。
c$$$        其中夸克JET的string tension 是胶子的一半。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        DP为能损,PTOT为横动量,PP(I,1..3):为三动量。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
C********************************************************
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        ISG:即是NSG的另一个名字,即the total number of such string
c$$$        system I.
c$$$        IASG(ISG,1), IASG(ISG,2):to specify which projectile and
c$$$        target nucleons produce string system I.(具体化是弹核还是
c$$$        靶核的核子产生了这个string).
c$$$        NJSG(I=1..NSG):numbers of partons in the string system I.
c$$$        string system I 产生的部分子的数量。
c$$$        XJ：横向X方向的距离。
c$$$        YJ：纵向Y方向的距离。
c$$$        PTJET0：横动量。
c$$$        PXSG：X方向的动量。
...
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      TO arrange the produced partons together with the valence
c$$$      quarks and diquarks(anti-quarks)and LUEXEC subroutine in JETSET
c$$$      is called to perform the frigmentation for each string system.
c$$$      (安排产生的部分子和夸克以及反夸克,配合LUEXEC程序两个程序共同完
c$$$      成)。
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        NTP: NTP = 3 is independent strings from jets.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        IF(NTP.EQ.3) THEN
                ISG=JTP
                N=NJSG(ISG)
                DO 100 I=1,NJSG(ISG)
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        K1SG(I,J):(J=1..NJSG(I))color flow information of parton J
c$$$        in strings system I.
c$$$        K2SG(I,J):(J=1..NJSG(I)):flavor code of parton J in
c$$$        string system I.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                   K(I,1)=K1SG(ISG,I)
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        对于NFP(JTP,15)=-1 NFP(JTP,1)是在-Z的方向。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
C        ********for NFP(JTP,15)=-1 NFP(JTP,1) IS IN -Z DIRECTION
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        PB1：价夸克和反夸克的横向动量PX的和。
c$$$        PB2：价夸克和反夸克的横向动量PY的和。
c$$$        PB3：Z方向的分量。
c$$$        PECM：质心系的能量。
c$$$        BTZ：BETA的分量。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        ENDIF        
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        对于NFT(JTP,15)=1, NFT(JTP,1)是沿着+Z方向的。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
C
C
        SUBROUTINE JETINI(JP,JT,itrig)          !!!!!!!!!!!已阅
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        IHNT2(12)=JT
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        参加反应的两个核子是什么样的两个核子。从而给itype进行赋值。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        NPJ(I)=0
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        当I大于核子的电荷数时,将核子的味道代码赋为中子2112.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        此调用ATTFLV的作用就是返回核子的组分夸克和反夸克的ID号。
c$$$        其中NFT(I,3)为核子的ID,IDQ和下面两行的NFT(I,1)为夸克的ID号。
c$$$        其中IDQQ和下面两行的NFT(I,2)为反夸克的ID号。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        利用flavor code即夸克和反夸克的ID号,调用质量函数ULMASS(),
c$$$        给出第I个核子的夸克的质量PP(I,14)和反夸克的质量PP(I,15).
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        PT(I,14)=ULMASS(IDQ)
        PT(I,15)=ULMASS(IDQQ)
200        CONTINUE
...
C
C
        SUBROUTINE ATTFLV(ID,IDQ,IDQQ)       !!!!!!!!!!!!!!!!!!!!!!!!已阅
      COMMON/RNDF77/NSEED
cc      SAVE /RNDF77/
        SAVE   
C
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        此Subroutine的作用就是返回核子的组分夸克和反夸克的ID号。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        ID为核子的原始味道代码,即核子的ID号。
c$$$        IDQ为该核子(核子的id号为ID)的夸克的flavor code(即夸克ID号)。
c$$$        IDQQ为该核子(核子的id号为ID)的反夸克的flavor code(即反夸克ID号)。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c*******************************************************************
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        此程序在它们自己的核子中完成核子的弹性散射和可能的cascade.
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        SUBROUTINE HIJCSC(JP,JT)           !!!!!!!!!!!!!!!!!!!!!已阅
...
10        CONTINUE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        Subroutine子程序的调用完成两个核子之间的弹性散射。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$        此程序完成两个核子之间的弹性散射。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        SUBROUTINE HIJELS(PSC1,PSC2)      !!!!!!!!!!!!!!!!!!!!!!!!!!!已阅
        IMPLICIT DOUBLE PRECISION(D)
        DIMENSION PSC1(5),PSC2(5)
        COMMON/HPARNT/HIPR1(100),IHPR2(50),HINT1(100),IHNT2(50)
cc      SAVE /HPARNT/
...
C ********************************************************
C ************************              WOOD-SAX
        SUBROUTINE HIJWDS(IA,IDH,XHIGH)            !!!!!!!已阅。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$        设定原子核的HIJWDS势。
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
c$$$             WW        WW      RR  RR   II     TT     EEEEEE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<
             write(9992,*) "R is radius param = ", R
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         WW       WW        WW RRRRRRR  II TTTTTTTTTT EEEEEE
c$$$          WW     WW WW     WW  RR  RR   II     TT     EE
c$$$           WW   WW   WW   WW   RRRRR    II     TT     EEEEEE
...
C
        SUBROUTINE TITLE
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
c$$$         2222222222222222222222222222222222222222222222222222222
c$$$         2222222222222222222222222222222222222222222222222222222
c$$$      >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      COMMON/RNDF77/NSEED
cc      SAVE /RNDF77/
