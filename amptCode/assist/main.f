...
c     AMPT momentum and space info at freezeout:
      open (6789,file='xiaohai_test/shuaping.dat', status = 'unknown')
      OPEN (16, FILE = 'ana/ampt.dat', STATUS = 'UNKNOWN')
      OPEN (14, FILE = 'ana/zpc.dat', STATUS = 'UNKNOWN')
      OPEN (9999, FILE = 'xiaohai_test/zpcrun.dat', STATUS = 'UNKNOWN')
      OPEN (9998, FILE = 'xiaohai_test/zpcrun2.dat', STATUS = 'UNKNOWN')
      OPEN (9997, FILE = 'xiaohai_test/newpos.dat', status = 'unknown')
      OPEN (9996, FILE = 'xiaohai_test/iff.dat', status = 'unknown')
      OPEN (9995, FILE = 'xiaohai_test/newmum.dat', status = 'unknown')
      OPEN (9994, FILE = 'xiaohai_test/chkcel.dat', status = "unknown")
      open (9993, FILE = 'xiaohai_test/ihpr2_12.dat', status ="unknown")
      open (9992, file = 'xiaohai_test/randius.dat', status = 'unknown')
      open (9991, file = "xiaohai_test/nsg.dat", status = 'unknown')
      open (9990, file='xiaohai_test/njsgs_isg.dat',status ='unknown')
      open (9989,file='xiaohai_test/zpc_hj.dat', status = "unknown")
      open (9988,file='xiaohai_test/hadron.dat', status = 'unknown')
      open (9987, file="xiaohai_test/id.dat", status = "unknown")
      open (9986,file="xiaohai_test/y1_y2,dat", status = "unknown")
      open (9985,file="xiaohai_test/info.dat", status = "unknown")
      open (9984, file='xiaohai_test/nsub.dat', status = "unknown")
